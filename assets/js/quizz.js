...
var author$project$Main$audioToSignAndName = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessBreak = _n0.guessBreak;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$nameAndSignToAudio = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessBreak = _n0.guessBreak;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$nameToAudioAndSign = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessBreak = _n0.guessBreak;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$signToAudioAndName = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessBreak = _n0.guessBreak;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$flashSignToName = function (_n0) {
	var guessBreak = _n0.guessBreak;
	var time = _n0.time;
	var questionStartTime = _n0.questionStartTime;
	var textAnswer = _n0.textAnswer;
	var textAnswerKey = _n0.textAnswerKey;
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$trackRender = function (_n0) {
	var breakName = _n0.a;
	var track = _n0.b;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$flashSignToTrack = function (_n0) {
	var breakPool = _n0.breakPool;
	var trackPool = _n0.trackPool;
	var time = _n0.time;
	var questionStartTime = _n0.questionStartTime;
	var guessBreak = _n0.guessBreak;
	return A2(
...
var author$project$Main$shuffledNameToSign = function (_n0) {
	var breakPool = _n0.breakPool;
	var shuffledName = _n0.shuffledName;
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$shuffledNameToTrack = function (_n0) {
	var breakPool = _n0.breakPool;
	var trackPool = _n0.trackPool;
	var shuffledName = _n0.shuffledName;
	return A2(
...
var author$project$Main$trackToName = function (_n0) {
	var guessTrack = _n0.guessTrack;
	var textAnswer = _n0.textAnswer;
	var textAnswerKey = _n0.textAnswerKey;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$trackToSign = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessTrack = _n0.guessTrack;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$audioToName = function (_n0) {
	var guessBreak = _n0.guessBreak;
	var textAnswer = _n0.textAnswer;
	var textAnswerKey = _n0.textAnswerKey;
	return A2(
...
var author$project$Main$audioToSign = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessBreak = _n0.guessBreak;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$nameToAudio = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessBreak = _n0.guessBreak;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$nameToSign = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessBreak = _n0.guessBreak;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$signToAudio = function (_n0) {
	var breakPool = _n0.breakPool;
	var guessBreak = _n0.guessBreak;
	return A2(
		elm$html$Html$div,
...
var author$project$Main$signToName = function (_n0) {
	var guessBreak = _n0.guessBreak;
	var textAnswer = _n0.textAnswer;
	var textAnswerKey = _n0.textAnswerKey;
	return A2(
...
var author$project$Main$timeAttack = 180000;
				...
				case 'RandomBreak':
					...
					var breakToAdd = function () {
						if (selected.$ === 'Just') {
							...
							var _n5 = A2(elm$core$Dict$get, breakName, model.breaks);
							if (_n5.$ === 'Just') {
								var _break = _n5.a;
								return _List_fromArray(
									[_break]);
...
var author$project$Main$renderQuestion = function (model) {
	...
	var _n0 = A2(elm$core$Dict$get, model.questionName, levelQuestions);
	if (_n0.$ === 'Just') {
		var question = _n0.a;
		return A2(
			elm$html$Html$div,
